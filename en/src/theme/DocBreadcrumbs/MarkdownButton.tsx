...
export default function MarkdownButton({markdownUrl}: MarkdownButtonProps): React.ReactNode {
  ...
  const getPromptWithMarkdown = () => {
    ...
    return `Could you read this document about WSO2 Open Healthcare ${fullUrl} so I can ask questions about it?`;
  };
          ...
          <div className={styles.markdownDropdownMenu}>
            <button className={styles.markdownDropdownItem} onClick={handleCopyPage}>
              ...
              <div className={styles.markdownDropdownItemText}>
                <span className={styles.markdownDropdownItemTitle}>
                  {copyError ? 'Copy failed!' : 'Copy page'}
                </span>
                <span className={styles.markdownDropdownItemDesc}>
