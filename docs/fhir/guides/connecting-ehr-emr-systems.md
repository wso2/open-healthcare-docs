...
![Epic connector in the palette](/assets/img/guides/configuring-ehr-emr-system/epic-in-palatte.png)
...
![Integration canvas with Epic connector operations](/assets/img/guides/configuring-ehr-emr-system/canvas.png)
...
![Init operation property pane](/assets/img/guides/configuring-ehr-emr-system/property.png)
...
![searchPatient operation property pane](/assets/img/guides/configuring-ehr-emr-system/patient.png)
